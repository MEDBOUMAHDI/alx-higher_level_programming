...
class TestSquare_stdout(unittest.TestCase):
    ...
    @staticmethod
    def capture_stdout(square, meth):
    ...
    def test_str_method_print_size(self):
        sq = Square(4)
        capt = TestSquare_stdout.capture_stdout(sq, "print")
        corr = "[Square] ({}) 0/0 - 4\n".format(sq.id)
        self.assertEqual(corr, capt.getvalue())

    def test_str_method_size_x(self):
        sq = Square(5, 5)
        corr = "[Square] ({}) 5/0 - 5".format(sq.id)
        self.assertEqual(corr, sq.__str__())

    def test_str_method_size_x_y(self):
        sq = Square(7, 4, 22)
        corr = "[Square] ({}) 4/22 - 7".format(sq.id)
        self.assertEqual(corr, str(sq))
    ...
    def test_display_size(self):
        sq = Square(2, 0, 0, 9)
        capt = TestSquare_stdout.capture_stdout(sq, "display")
        self.assertEqual("##\n##\n", capt.getvalue())
...
class TestSquare_update_args(unittest.TestCase):
    ...
    def test_update_args_None_id(self):
        sq = Square(10, 10, 10, 10)
        sq.update(None)
        corr = "[Square] ({}) 10/10 - 10".format(sq.id)
        self.assertEqual(corr, str(sq))

    def test_update_args_None_id_and_more(self):
        sq = Square(10, 10, 10, 10)
        sq.update(None, 4, 5)
        corr = "[Square] ({}) 5/10 - 4".format(sq.id)
        self.assertEqual(corr, str(sq))
...
class TestSquare_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_None_id_and_more(self):
        ...
        corr = "[Square] ({}) 18/10 - 7".format(sq.id)
        self.assertEqual(corr, str(sq))
