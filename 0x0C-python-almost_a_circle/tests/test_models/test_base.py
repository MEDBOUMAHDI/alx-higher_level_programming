...
class TestBase_save_to_file(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        try:
            obsq.remove("Rectangle.json")
        except IOError:
            pass
        try:
            obsq.remove("Square.json")
        except IOError:
            pass
        try:
            obsq.remove("Base.json")
        except IOError:
            pass
    ...
    def test_save_to_file_two_rectangles(self):
        ...
        with open("Rectangle.json", "r") as fl:
            self.assertTrue(len(fl.read()) == 105)
    ...
    def test_save_to_file_two_squares(self):
        ...
        with open("Square.json", "r") as fl:
            self.assertTrue(len(fl.read()) == 77)
...
class TestBase_from_json_string(unittest.TestCase):
    ...
    def test_from_json_string_type(self):
        l_input = [{"id": 89, "width": 10, "height": 4}]
        js_l_input = Rectangle.to_json_string(l_input)
        l_output = Rectangle.from_json_string(js_l_input)
        self.assertEqual(list, type(l_output))

    def test_from_json_string_one_rectangle(self):
        l_input = [{"id": 89, "width": 10, "height": 4, "x": 7}]
        js_l_input = Rectangle.to_json_string(l_input)
        l_output = Rectangle.from_json_string(js_l_input)
        self.assertEqual(l_input, l_output)
    ...
    def test_from_json_string_one_square(self):
        l_input = [{"id": 89, "size": 10, "height": 4}]
        js_l_input = Square.to_json_string(l_input)
        l_output = Square.from_json_string(js_l_input)
        self.assertEqual(l_input, l_output)
...
class TestBase_load_from_file(unittest.TestCase):
    ...
    def test_load_from_file_first_rectangle(self):
        ...
        Rectangle.save_to_file([rect1, rect2])
        l_rect_output = Rectangle.load_from_file()
        self.assertEqual(str(rect1), str(l_rect_output[0]))
    ...
    def test_load_from_file_second_rectangle(self):
        ...
        Rectangle.save_to_file([rect1, rect2])
        l_rect_output = Rectangle.load_from_file()
        self.assertEqual(str(rect2), str(l_rect_output[1]))
    ...
    def test_load_from_file_rectangle_types(self):
        ...
        self.assertTrue(all(type(objec) == Rectangle for objec in oput))

    def test_load_from_file_first_square(self):
        sq1 = Square(5, 1, 3, 3)
        sq2 = Square(9, 5, 2, 3)
        Square.save_to_file([sq1, sq2])
        l_sq_output = Square.load_from_file()
        self.assertEqual(str(sq1), str(l_sq_output[0]))
    ...
    def test_load_from_file_second_square(self):
        ...
        Square.save_to_file([sq1, sq2])
        l_sq_output = Square.load_from_file()
        self.assertEqual(str(sq2), str(l_sq_output[1]))
    ...
    def test_load_from_file_square_types(self):
        ...
        self.assertTrue(all(type(objec) == Square for objec in oput))
...
class TestBase_save_to_file_csv(unittest.TestCase):
    ...
    def tearDown(self):
        """Delete any created files."""
        try:
            obsq.remove("Rectangle.csv")
        except IOError:
            pass
        try:
            obsq.remove("Square.csv")
        except IOError:
            pass
        try:
            obsq.remove("Base.csv")
        except IOError:
            pass
    ...
    def test_save_to_file_csv_one_rectangle(self):
        ...
        with open("Rectangle.csv", "r") as fl:
            self.assertTrue("5,10,7,2,8", fl.read())
    ...
    def test_save_to_file_csv_one_square(self):
        ...
        with open("Square.csv", "r") as fl:
            self.assertTrue("8,10,7,2", fl.read())
...
class TestBase_load_from_file_csv(unittest.TestCase):
    ...
    def test_load_from_file_csv_first_rectangle(self):
        ...
        rect2 = Rectangle(2, 4, 5, 6, 2)
        Rectangle.save_to_file_csv([rect1, rect2])
        l_rect_output = Rectangle.load_from_file_csv()
        self.assertEqual(str(rect1), str(l_rect_output[0]))
    ...
    def test_load_from_file_csv_first_square(self):
        ...
        sq2 = Square(9, 5, 2, 3)
        Square.save_to_file_csv([sq1, sq2])
        l_sq_output = Square.load_from_file_csv()
        self.assertEqual(str(sq1), str(l_sq_output[0]))
